    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InvitationsSite", x => new { x.Uid, x.Rno });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NouveauxSites", x => x.Email);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ArchiveSites_Sites_Uid_Rno",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Etat = table.Column<string>(maxLength: 1, nullable: true, defaultValue: "A"),
                    Nom = table.Column<string>(maxLength: 200, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Lignes", x => new { x.Uid, x.Rno, x.No, x.Uid2, x.Rno2, x.No2, x.Date, x.Type });
                    table.ForeignKey(
