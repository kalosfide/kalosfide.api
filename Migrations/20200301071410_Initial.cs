    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArchiveFournisseurs", x => new { x.Uid, x.Rno, x.Date });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Produits_Sites_Uid_Rno",
                        columns: x => new { x.Uid, x.Rno },
                        principalTable: "Sites",
                        principalColumns: new[] { "Uid", "Rno" },
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArchiveFournisseurs_Uid_Rno",
                table: "ArchiveFournisseurs",
                columns: new[] { "Uid", "Rno" });
